...
public class UnigramsSDM {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String usage =
                "Usage:\tjava com.eb02.UnigramsSDM [-index dir] [-queries file] [-run_id]\n\nCheck out our github for more details.";
        ...
        for (int e = 0; e < topic.size(); e++) {
            ...
            for (int x = 0; x < terms.length; x++) {
                Query query = parser.createPhraseQuery("contents", terms[x]);
            ...
            List<Docs> ug_list = new ArrayList<Docs>(); //Final list of collected unigram results (didn't use yet)
